...
DeepSeek MoE dense compute.
Methods:
  - baseline: dense HF model
  - uniform_dense: uniform 2:4 pruning on routed experts
...
def apply_uniform_dense(model):
    """Apply uniform 2:4 pruning to routed experts in-place (HF dense compute)."""
...
def apply_exact_dense(model, profiling_json, cold_as_24=False):
    """Apply EXACT hot/cold pruning to routed experts in-place (HF dense compute)."""
...
def main():
    ...
    parser.add_argument('--profiling_json', default='artifacts/exact_profiling/deepseek-moe-16b-base_c4_real_e64_layer.json')
