...
def main():
    ...
    while step < args.steps:
        ...
        if (step + 1) % args.grad_accum == 0:
            ...
            with torch.no_grad():
                if use_fsdp:
                    # Correctness-first: reapply masks on full params under FSDP.
                    # offload_to_cpu avoids GPU OOM during unshard.
        ...
        if use_fsdp:
            if args.save_mode == 'full':
                ...
                if rank == 0:
                    ...
                    model_to_save.load_state_dict(state_dict, strict=True)
